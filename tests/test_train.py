"""Tests for the Training Grounds — pure logic + DB-backed train/claim flow."""
...
from wagame.cogs.train import claim_finished_training, start_training
...
async def db(tmp_path: Path) -> Database:
    database = Database(tmp_path / "train.db")
